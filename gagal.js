...
const apiKey = "bbsg7EhMm0ldDwaeWa55C9cW3huiUQ3z9id1WZ5i"; // Global API key BUAT WILDCAR
const apiToken = "e1d2b64d4da5e42f24c88535f12f21bc84d06"; // Daily Requests 421,124 Daily Bandwidth 84.52 GB
    ...
    .pipeTo(
      new WritableStream({
        async write(chunk, controller) {
          if (isDNS) {
            return handleUDPOutbound(DOH_URL, chunk, webSocket, null, log);
          }
