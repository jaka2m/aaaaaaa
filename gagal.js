...
var proxyListURL = "https://raw.githubusercontent.com/ngalagurame/msubproxy/refs/heads/main/proxyList.txt";
var namaWeb = "xxxxx";
var telegramku = "xxx";
var wildcards = [
  "ava.game.naver.com",
...
var worker_default = {
  async fetch(request, env, ctx) {
    try {
      ...
      const CHECK_API_BASE = env.CHECK_API_BASE;
...
<body>
    ...
    <option value="ZW">Zimbabwe</option>
                ...
                <a href="https://saca.sandalcapit.my.id/web" class="tombol">Menu Utama</a>
    ...
    <div class="quantum-container">
        ...
        <h1 class="quantum-title">
            ...
            <div class="search-quantum" style="display: flex; align-items: center; flex-direction: column;">
              ...
              ${searchQuery ? `<button id="home-button" class="bg-gradient-to-r from-[#39ff14] to-[#008080] text-[#ffffff] border-2 border-[#39ff14] rounded-md px-2 py-0.5 text-sm transition duration-300 ease-in-out hover:bg-[#008080] hover:text-[#222222]" style="margin-top: 0.4rem;" onclick="goToHomePage('${hostName}')">
                  Home Page
                </button>` : ""}
            </div>
            <br>
